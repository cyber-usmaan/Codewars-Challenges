...
def expression_matter(a, b, c): # Given function
    return max ((a + b) * c, (b + c) * a, a * b * c, a + b + c)  #created a few expressions, these passed all the test returning the max values inaccordance with provided solutions
